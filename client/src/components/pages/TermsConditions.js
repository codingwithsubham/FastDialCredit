  ...
  return (
    <div className="terms-conditions">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Happy
        Family Marketing.
      </p>{" "}
      <p>
        Fastdial Credit is committed to ensuring that the app is as
      ...
      <p>
        The Fastdial Credit app stores and processes personal data that
        ...
        phone's security features and it could mean that the Happy Family
        Marketing app won't work properly or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Happy Family
        Marketing will not take responsibility for. Certain functions of the app
        ...
        Fastdial Credit cannot take responsibility for the app not
      ...
      <p>
        Along the same lines, Fastdial Credit cannot always take
        ...
        turn it on to avail the Service, Fastdial Credit cannot accept
        responsibility.
      </p>{" "}
      <p>
        With respect to Fastdial Credit’s responsibility for your use of
        ...
        we can make it available to you. Fastdial Credit accepts no
      ...
      <p>
        ...
        updates if you want to keep using the app. Fastdial Credit does
      ...
      <p>These terms and conditions are effective as of 2023-04-14</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at hf71045@gmail.com.
      </p>{" "}
    </div>
  );
};
