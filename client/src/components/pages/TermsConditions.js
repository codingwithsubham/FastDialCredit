...
const TermsConditions = () => {
  return (
    <div className="terms-conditions insta-an">
      ...
      <p>
        Fastdial Credit is committed to ensuring that the app is as useful and
      ...
      <p>
        The Fastdial Credit app stores and processes personal data that you have
        ...
        features and it could mean that the Fastdial Credit app won't work
        properly or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Fastdial Credit
        ...
        can be Wi-Fi or provided by your mobile network provider, but Fastdial
        Credit cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Fastdial Credit cannot always take responsibility
        ...
        avail the Service, Fastdial Credit cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Fastdial Credit’s responsibility for your use of the
        ...
        we can make it available to you. Fastdial Credit accepts no liability
      ...
      <p>
        ...
        updates if you want to keep using the app. Fastdial Credit does not
